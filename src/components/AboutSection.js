...
export default function AboutSection(props) {
  ...
  let content = {
    EN: {
      ...
      link: "More about us",
      content1:
        "We consult and provide transportation services, " +
      ...
      content2:
        "We also offer supporting services including: domestic " +
    ...
    VI: {
      ...
      content1:
        "SOVI chuyên tư vấn và cung cấp dịch vụ vận chuyển " +
      ...
      content2:
        "Bên cạnh đó, chúng tôi cung cấp các dịch vụ hỗ trợ đi " +
