...
const Equipment = () => {
  let content = {
    EN: {
      ...
      desc: "Description",
      descContent:
        "Common container types and necessary specification related to stuffing into container.",
    },

    VI: {
      title: "Thiết bị",
      breadcrumb: [{ name: "Thiết bị" }],
      ...
      desc: "Giới thiệu",
      descContent:
        "Một số container thông dụng và các thông số cần " +
...
export function GeneralPurpose() {
  ...
  const genPurposeItems = [
    [imgContainer.equipment20_02.childImageSharp.fluid, content.eq20, "eq-20"],
    [imgContainer.equipment40_01.childImageSharp.fluid, content.eq40, "eq-40"],
    [
      imgContainer.equipment40_01.childImageSharp.fluid,
      content.eq40Hq,
      "eq-40-hq",
    ],
    [imgContainer.equipment40_01.childImageSharp.fluid, content.eq45, "eq-45"],
  ]
  return (
    <div className="row">
